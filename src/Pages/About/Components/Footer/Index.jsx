...
const FooterArea = () => {
  return (
    <div>
      <Box position={'relative'} bgcolor={'#212121'} width={'100%'} mt={{md:250,sm:300,xs:480}} top={40} p={8}>
        <Grid container alignItems={'center'}>
          ...
          <Grid item md={6} sm={4}  color={'white'}>
            <Box display={{ xs: 'block',sm:'flex', md: 'flex' }} justifyContent={'space-around'} alignItems={'center'}>
              <Box>
                <List>
                  <ListItem><Link href="#" sx={{ textDecoration: 'none', color: 'red' }}>ABOUT</Link></ListItem>
